...
<!-- Breadcromb Area Start -->
    ...
    <section class="gauto-contact-area section_70">
        <div class="container pt-5">
            ...
            <div class="border sombrainterna row my-4 justify-content-center bg-fondo  py-4 mx-1 ">
                
                <div class="col-md-4 col-11 text-center align-self-center" >  
                    
                    <div class="row justify-content-center bg-light text-dark mb-1 py-3">
                        <h5 >{{$disponible->nombre_vehiculo}}</h5>
                            ...
                            <div class="row justify-content-center py-3">
                                <div class="col-md-5 col-5   bg-light text-dark">Desde</div>
                                <div class="col-md-5 col-5  bg-light text-dark">Hasta</div>
                                <div class="col-md-5 col-5  bg-light text-dark">{{$desdes}}</div>
                                <div class="col-md-5 col-5 bg-light text-dark">{{$hastas}}</div>
                            </div>
                            <div class="row  mb-1 text-center">
                                <div class="col-md-6  col-4  bg-light text-dark text-center">Total Dias</div>
                            ...
                            <div class="row  mb-1">
                                <div class="col-md-6 col-4 bg-light text-dark">Precio Alquiler</div>
                                <?php 
                            ...
                            <div class="row  mb-1">
                                <div class="col-md-6 col-4 bg-light text-dark">Total</div>
                                <div class="col-md-6 col-8 bg-black text-light align-items-center"><h5>${{
                                number_format($valor_suma+$transporte_precio+$transporte_precio1, 0);}}</h5></div>
                            </div>
    ...
    <br>
                            ...
                            <input type="button" id="sgt" class="btn btn-light " value="Siguiente">
                        </div>
                       ...
                       <div id="parte3" style="display: none;">
                            ...
                            <h3 class="text-light my-3">Hola me alegra tenerte por aqui</h3>
                            <p class="lead text-light text-justify my-1">
                                
                        
                               
                                <br>
                                <b id="nombre_encontrado" class="text-secondary"></b>
                                <br> <br>
                                es un gusto que reserves con nosotros nuevamente 
                                <br>
                                <br>
                            </p>
                        <button type="submit" class="btn btn-light m-t-15 waves-effect">RESERVAR AHORA</button>
                       </div>
